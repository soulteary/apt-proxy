...
<head>
    ...
    <title>apham0001/apt-proxy</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="header clearfix">
            <a href="https://github.com/apham0001/apt-proxy" target="_blank" class="logo">
                <img width="80"
                    ...
                    alt="APT Proxy"></a>
            <h2><a href="https://github.com/apham0001/apt-proxy" target="_blank">apham0001/apt-proxy</a></h2>
        ...
        <div class="stats stats-bottom clearfix">
            ...
            <a href="https://github.com/apham0001/apt-proxy/issues" class="stat enable" target="_blank">
