...
var hostPatternMap = map[*regexp.Regexp][]Define.Rule{
	...
	Define.DEBIAN_SECURITY_HOST_PATTERN:	Define.DEBIAN_SECURITY_DEFAULT_CACHE_RULES,
	Define.CENTOS_HOST_PATTERN:       		Define.CENTOS_DEFAULT_CACHE_RULES,
	Define.ROCKY_HOST_PATTERN:       		Define.ROCKY_DEFAULT_CACHE_RULES,
	Define.FEDORA_HOST_PATTERN:      		Define.FEDORA_DEFAULT_CACHE_RULES,
